...
<template>
  <div class="contenedor ancho-fijo p-b-maximo">
    <div class="ancho-lectura p-b-1">
      <h1 class="texto-centrado">sisdai-estilos</h1>
      <p>
        ...
        (<a href="https://sisdai.org/" target="_blank">Sisdai</a>).
      </p>
      <p>
        <i>sisdai-estilos</i> es una biblioteca de estilos de Sass que normaliza la forma
